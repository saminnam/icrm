...
const ManageUsers = () => {
  ...
  const [customersPerPage] = useState(10); // You can adjust this number
  ...
  const totalPages = Math.ceil(sortedUsers.length / customersPerPage);
  ...
  return (
    <section className="flex flex-col">
      ...
      {/* Pagination Controls */}
      {!loading && sortedUsers.length > customersPerPage && (
