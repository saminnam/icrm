  ...
  return (
    <section className="flex flex-col">
      <div className="pb-2 flex items-center justify-between border-b-2 mb-4 border-gray-300">
        <PageTitle pageTitle={"Manage Customers"} />
        <BreadCrumbs pageName={"add-customer"} />
      </div>
          ...
          <div className="overflow-hidden border rounded border-gray-300">
            {loading ? (
              ...
              <div className="relative">
                <div className="overflow-y-auto md:w-full overflow-x-auto max-h-[60vh]">
                  <table className="table-auto min-w-full rounded">
                    <thead className="sticky top-0 bg-gray-50 z-10">
                      <tr>
                        ...
                        >
                          <div className="flex items-center justify-between">
                            Email ID {getSortIndicator("email")}
                          </div>
                        </th>
                        <th
                          scope="col"
